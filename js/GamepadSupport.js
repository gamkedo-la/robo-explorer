...
{
    // change these keycodes to suit your game
    var SIMULATED_KEY_UP = 87;//w
    var SIMULATED_KEY_DOWN = 83;//s
    var SIMULATED_KEY_LEFT = 65;//a
    var SIMULATED_KEY_RIGHT = 68;//d
    var SIMULATED_KEY_B_BUTTON = 69;//e
    var SIMULATED_KEY_A_BUTTON = 32;//space
    var SIMULATED_KEY_X_BUTTON = 13;//enter
    ...
    if (!navigator.getGamepads) {
        ...
        console.log("Gamepad Support is ENABLED. Click any button on your gamepad to connect!");
    }
