...
function loadImages() {
  ...
  var imageList = [
     ...
     { varName: heroPic, theFile: "robo-explorer-walkcycle17-explosion.png"},
    ...
    { trackType: WORLD_WALL3, theFile: "worldForest_ground5.png" },
    { trackType: WORLD_CLOUD1, theFile: "cloud2.png" },
    ...
    { trackType: WORLD_LABORATORYENTRANCE, theFile: "laboratoryTree8.png" },
    ...
    { trackType: WORLD_FORESTROCK, theFile: "rocks.png" },
    ...
    { trackType: WORLD_STORYBOY, theFile: "BossCockroachStory7.png" },
    { trackType: WORLD_TRANSPARENT, theFile: "transparent.png" },
    { trackType: WORLD_BLACKTILES, theFile: "black.png" },
    { trackType: WORLD_DRAMBERVARD, theFile: "drambervard.png" },
    { trackType: WORLD_ENDING, theFile: "endingRobo-explorer2.png" },
    { trackType: WORLD_MEMORY, theFile: "memory.png" },
